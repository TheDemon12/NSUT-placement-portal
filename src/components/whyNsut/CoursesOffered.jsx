		...
		<div>
			<div className='courses'>
				...
				<Container style={{ marginTop: '5vh' }}>
					<p className='desc'>
						NSUT East Campus offers courses at the undergraduate and Graduate
						level in streams of Engineering and Technology.The institute is well
						known for offering traditional B.Tech and M.Tech Programs in domains
						of Computer Science and Electronics. NSUT East Campus has now
						introduced innovative and popular Undergraduate courses such as
						CSDA, ECAM and Graduate courses in Information Security and Digital
						Communication.
					</p>
